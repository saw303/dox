...
<div id="documentList">
    ...
    <c:forEach var="doc" items="${documents}">
        <div style="background: url('<c:url
                value="/resources/img/file-extensions/${doc.mimeType.split('/')[1].substring(0,3)}.png"/>') left top no-repeat; background-size: 32px; border: 1px solid; border-radius: 5px; margin-bottom: 5px; overflow: auto;">
            <div>
                ...
                <img src="https://si0.twimg.com/profile_images/3338360154/5e53da6653b47dbd93efb4ed4df1f5a2.png" style="display: block; float: right; margin: 10px"/>
