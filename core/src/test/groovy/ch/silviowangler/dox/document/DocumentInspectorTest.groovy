...
class DocumentInspectorTest extends Specification {
    ...
    def "test document inspectors"(DocumentInspector documentInspector, File file, int expectedPageCount) {
        ...
        new MicrosoftWordDocumentInspector(new DefaultExecutor(), new PdfDocumentInspector()) | loadFile('word-1-page.doc')  | 1
        new MicrosoftWordDocumentInspector(new DefaultExecutor(), new PdfDocumentInspector()) | loadFile('word-6-page.doc')  | 6
        new MicrosoftWordDocumentInspector(new DefaultExecutor(), new PdfDocumentInspector()) | loadFile('word-1-page.docx') | 1
    }
