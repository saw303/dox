...
(function (e, m, f) {
    ...
    TableTools.prototype = {fnGetSelected: function () {
        ...
        _fnCreateButton: function (a, b) {
            ...
            for (d in c)if ("i" != d && "t" != d && 1 == d.length)for (var g = 0, h = c[d].length; g < h; g++)this.dom.print.hidden.push({node: c[d][g], display: "block"}), c[d][g].style.display = "none";
    ...
    TableTools.BUTTONS = {csv: e.extend({}, TableTools.buttonBase, {sAction: "flash_save", sButtonClass: "DTTT_button_csv", sButtonText: "CSV", sFieldBoundary: '"',
        ...
        this.fnPrint(!0, b)
    }}), text: e.extend({}, TableTools.buttonBase), select: e.extend({}, TableTools.buttonBase, {sButtonText: "Select button",
        fnSelect: function (a) {
